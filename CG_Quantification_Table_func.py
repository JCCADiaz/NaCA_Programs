...
def top_CG_Qantification():
    ...
    parametros_ab = [[0,59292],[0,55129],[0,13290],[0,254],[0,3198],[0,232.973], [1,1]]#For N2 a and b parameters does not have any meaning
    ...
    def create_df_evolution():
        ...
        for gas in gases[:-1]: # disregards N2
            for i in range(len(df_in[gas])):
                ...
                if gas=='O2':
                    A_N2 = df_in.loc[i,'N2']
                    df_out.loc[i,gas] = round(calculo_Evolution_gas(Vt, gas, A, t, A_N2),5)
                else:
                    df_out.loc[i,gas] = round(calculo_Evolution_gas(Vt, gas, A, t),5)
        return df_out
