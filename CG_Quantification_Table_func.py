...
def top_CG_Gas_Qantification():
    ...
    dic_lineas = {'2':Vt_value('2'), '4':Vt_value('4'), '6':Vt_value('6'), '8':Vt_value('8'), '8L':Vt_value('8L'), '8S':Vt_value('8S'), '8P':Vt_value('8P')}
    #print(dic_lineas)
    dic_Vol_reactor = {'2':100.9, '4':100.9, '6':100.9, '8':100.9, '8L':100.9, '8S':4, '8P':1}# Volume do reator, ml 

    gases = ['CO', 'CH3-OH', 'C2H6O', 'O2', 'H2', 'CO2', 'N2']
