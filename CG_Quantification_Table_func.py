...
def top_CG_Gas_Qantification():
    ...
    length_of_lines = {'2':73, '4':272, '6':121, '8':314, '8L':298, '8S': 298+90.5, '8P':298+162.5} # 8H change to 8L
    ...
    dic_lineas = {'2':Vt_value('2'), '4':Vt_value('4'), '6':Vt_value('6'), '8':Vt_value('8'), '8L':Vt_value('8L'), '8S':Vt_value('8S'), '8P':Vt_value('8P'), '8D':Vt_value('8L')+Vcopo+Vtubo1+Vtubo2}
    
    #print(dic_lineas)
    dic_Vol_reactor = {'2':100.9, '4':100.9, '6':100.9, '8':100.9, '8L':100.9, '8S':4, '8P':1, '8D':100.9}# Volume do reator, ml 

    gases = ['CO', 'CH4', 'C2H6', 'O2', 'H2', 'CO2', 'N2']
    parametros_ab = [[0,59292],[0,55129],[0,132900],[0,254],[0,3198],[0,232.973], [1,1]]#For N2 a and b parameters does not have any meaning
    ...
    def calculo_Evolution_gas(line, gas, A, t, A_N2=0): # A:Area bajo la curva :: tau: tempo entre coletas, min :: 
        ...
        a, b = dic_parametros_ab[gas]  #calibration parameters  a=intercept ::: b=angular coef.
        ...
        # else:
        Evolution_gas = 3*((Area-a)/b)*(Vr+Vt+Vl+(t*f)-Vs)
