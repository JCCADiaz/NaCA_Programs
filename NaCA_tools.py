...
# Create Submenu CG
CG_submenu = Menu(processing_menu, tearoff=0)
processing_menu.add_cascade(label = "CG", menu = CG_submenu)
processing_menu.add_separator()

# Add items to CG Submenu
CG_submenu.add_command(label="Gas analysis (Agilent 7890B)", command = CGQTf.top_CG_Gas_Qantification_parameters)
CG_submenu.add_command(label="Liquid analysis (Agilent 8860)", command = CGQTf.top_CG_Liquid_Qantification)
